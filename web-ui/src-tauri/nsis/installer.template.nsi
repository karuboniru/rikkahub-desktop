...
; 5b. Rikkahub data-directory page — comes right after the install directory choice so the
; default ($INSTDIR\pc-data) is already populated. Function definitions live in our
; installer hooks file, which is `!include`d earlier in this template.
Page custom RikkahubDataDirPageCreate RikkahubDataDirPageLeave
